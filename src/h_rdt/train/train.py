...
def train(args, logger):
    ...
    for epoch in range(args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            with accelerator.accumulate(hrdt):      
                ...
                lang_embeds = None
                lang_attn_mask = None
                if args.training_mode == "lang" and args.precomp_lang_embed:
    ...
    # Save one final accelerator checkpoint for deployment/inference flows that
    # expect a checkpoint-* directory rather than only the root save_pretrained.
