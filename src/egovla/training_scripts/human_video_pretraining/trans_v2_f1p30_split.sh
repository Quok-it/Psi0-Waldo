...
RUN_NAME=mix4data-30hz-transv2update2-fingertip-20e-hdof5-3d200-rot5-lr1e-4-h5p30f1skip6-b$bs-$n_node
...
torchrun --nnodes=$n_node --nproc_per_node=8 --master_port=25001 \
    ...
    --data_mixture hoi4d_30hz_train+hot3d_30hz_train+taco_30hz_train+holoassist_train_30hz_sub5  \
    ...
    --eval_data_mixture hoi4d_30hz_eval_sub20+hot3d_30hz_eval_sub20+taco_30hz_eval_sub20+holoassist_eval_30hz_sub100 \
