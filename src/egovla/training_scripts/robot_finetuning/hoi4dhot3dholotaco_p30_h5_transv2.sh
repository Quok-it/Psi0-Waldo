...
RUN_NAME=otv-fixed-set-fixorder-30hz-hoi4dhot3dholotaco-transv2-100e-h5-3d20-rot5-lr2e-5-const-h5p30f1skip6-manoloss6l1-kp0-b$bs-$n_node
...
torchrun --nnodes=$n_node --nproc_per_node=8 --master_port=25001 \
    ...
    --model_name_or_path $CHECKPOINTS_ROOT/mix4data-30hz-transv2update2-fingertip-20e-hdof5-3d200-rot5-lr1e-4-h5p30f1skip6-b16-4 \
    --version qwen2 \
