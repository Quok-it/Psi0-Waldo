...
DATASET_PATH=/hfm/data/simple_hf/G1WholebodyXMovePick-v0 \
PRETRAINED_MODEL_PATH=nvidia/GR00T-N1.6-3B \
HF_HOME=/hfm/zhenyu/cache/huggingface \
HUGGINGFACE_HUB_CACHE=/hfm/zhenyu/cache/huggingface/hub \
...
RUN_DATA_DIR=/hfm/data/simple_hf/G1WholebodyXMovePick-v0 \
NUM_EPISODES=10 \
NUM_WORKERS=1 \
